(function(a) {
    function f(b) {
        if (!a("#toast-container").length) { var d = "top-right top-left top-center bottom-right bottom-left bottom-center".split(" ").includes(a.toastDefaults.position) ? a.toastDefaults.position : "top-right";
        ...
        r && (c += '<button type="button" class="ml-2 mb-1 close" data-dismiss="toast" aria-label="Close">\n                        <span aria-hidden="true" class="text-white">&times;</span>\n                    </button>');
        c += "</div>";
        ...
        a.toastDefaults.pauseDelayOnHover && (setTimeout(function() { k || a("#" + g).toast("hide") }, b.delay), a("body").on("mouseover", "#" + g, function() { k = !0 }), a(document).on("mouseleave", "#" + g, function() { var w = Math.floor(Date.now() / 1E3),
